...
def build_team_reports_pdf(reports: list[dict]) -> bytes:
    ...
    for i, row in enumerate(reports):
        ...
        if kind == "setter":
            ...
            _emit(pdf, "WhatsApp - conv. reales", row.get("conversaciones_whatsapp"))
            _emit(pdf, "WhatsApp - calendlys", row.get("links_enviados_whatsapp"))
            _emit(pdf, "WhatsApp - agendas", row.get("agendas_whatsapp"))
