...
class SetterReport(db.Entity):
    ...
    conversaciones_youtube = Required(int, default=0)
    conversaciones_ads = Required(int, default=0)
    chats_youtube = Required(int, default=0)
    chats_ads = Required(int, default=0)
    agendas_stories = Required(int, default=0)
    agendas_reels = Required(int, default=0)
    agendas_youtube = Required(int, default=0)
    agendas_ads = Required(int, default=0)
    agendas_youtube_directo = Required(int, default=0)
    links_enviados_stories = Required(int, default=0)
    links_enviados_reels = Required(int, default=0)
    links_enviados_youtube = Required(int, default=0)
    links_enviados_ads = Required(int, default=0)
    notas = Optional(str, default="")
